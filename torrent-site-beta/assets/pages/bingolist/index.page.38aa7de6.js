...
function G() {
    ...
    return e.jsxs("div", {
        className: h("page-max-width-wrap casino-container", T),
        children: [e.jsx("div", {
            className: "bingo-tit",
            children: a("Bingo")
        }), e.jsx(M, {
...
const A = ({
    ...
    return {
        ...
        bingoOnlinePlayData: k()
    }
};
export {
    V as Page, A as onPageData
};