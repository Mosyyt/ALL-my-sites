...
class V extends j {
    constructor() {
        ...
        let t = [0, 14, 9, 8, 2, 19, 4, 11, 6, 3, 5, 13, 12, 7, 10, 15, 16, 17, 18];
        globalThis.location && Q.includes(globalThis.location.host) && t.forEach((s, i, n) => {
            n[i] = s + 100
        }), this.rooms = [new r(t[0], "Global", this), new r(t[1], "Sports", this), new r(t[2], c.en[0], this), new r(t[3], c.pt[0], this), new r(t[4], c.id[0], this), new r(t[5], c.bn[0], this), new r(t[6], c.ru[0], this), new r(t[7], c.fa[0], this), new r(t[8], c.es[0], this), new r(t[9], c.vi[0], this), new r(t[10], c.tl[0], this), new r(t[11], c.de[0], this), new r(t[12], c.hi[0], this), new r(t[13], c.my[0], this), new r(t[14], c.fr[0], this), new r(t[15], c.ko[0], this), new r(t[16], c.th[0], this), new r(t[17], c.ur[0], this), new r(t[18], c.ja[0], this)], this.roomDict = this.rooms.reduce((s, i) => (s[i.id] = i, s), {}), this.currentRoom = this.storage.lastRoomid === -1 ? this.getRoomByI18n(b.language) : this.getRoomByid(this.storage.lastRoomid), this.onScroll = this.onScroll.bind(this), this.bindEvent(), this.socket.connect(); {
            const s = () => {
